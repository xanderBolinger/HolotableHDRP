...
public class AircraftMoraleTests
{
    ...
    public void MoraleCheck_WithHighModifiedRoll_ShouldJettison()
    {
        ...
        MoraleCheck(flight, hasSurprise: true, disadvantage: false, enemyCasualties: 0, friendlyCasualties: 0);
    ...
    public void MoraleCheck_WithLowModifiedRoll_ShouldAbort()
    {
        ...
        MoraleCheck(flight, hasSurprise: false, disadvantage: false, enemyCasualties: 2, friendlyCasualties: 3);
    ...
    public void MoraleCheck_WithDisorderAndAgressionDecrement_ShouldUpdateAgression()
    {
        ...
        MoraleCheck(flight, hasSurprise: false, disadvantage: true, enemyCasualties: 1, friendlyCasualties: 0);
